...
def standardise_phones(*args):
    ...
    # Тоже отличное решение. Можно решить через библиотеку - см ответы
...
# Хорошее решение. Есть чуть другие в ответах, но твой вариант выглядит даже оптимальней
